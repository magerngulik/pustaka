...
<h1 class="h3 mb-4 text-gray-800"><?= $title; ?></h1>
    ...
    $siswa =$this->db->count_all_results();
    ?>
    <?php 
    $this->db->select('*');
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <!-- <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><?= $sdhkembali?></div>
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><?= $pinjaman?></div>
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><?= $new_width?></div> -->
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $pinjaman?></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-users fa-2x text-black-300"></i>
                    </div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-black-800"><?=$total?>%</div>
                        </div>
                        <div class="col">
                          <div class="progress progress-sm mr-2">
                            <div class="progress-bar bg-black" role="progressbar" style="width: <?=$total?>%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                          </div>
                        </div>
                      </div>
                    </div>
